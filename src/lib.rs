...
pub fn solve(day: u8, part: u8, input: &str) -> String {
    match day {
        ...
        9 => match part {
            1 => day09::part1(input).to_string(),
            2 => day09::part2(input).to_string(),
            _ => "Invalid part".to_string(),
        },
        10 => match part {
            1 => day10::part1(input).to_string(),
            2 => day10::part2(input).to_string(),
            _ => "Invalid part".to_string(),
        },
        11 => match part {
            1 => day11::part1(input).to_string(),
            2 => day11::part2(input).to_string(),
            _ => "Invalid part".to_string(),
        },
        12 => match part {
        ...
        13 => match part {
            1 => day13::part1(input).to_string(),
            2 => day13::part2(input).to_string(),
            _ => "Invalid part".to_string(),
        },
        14 => match part {
            1 => day14::part1(input).to_string(),
            2 => day14::part2(input).to_string(),
            _ => "Invalid part".to_string(),
        },
        // Add more days here
